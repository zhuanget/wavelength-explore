...
//////////******************以下配置根据项目自己手动配置*******************************////////
    ...
    //要生成的表名
    private static String[] tables = {"t_simple_book"};
    //table前缀
    ...
    private static String url = "jdbc:mysql://127.0.0.1:3306/archie_data?useUnicode=true&characterEncoding=utf8&useSSL=false";
